...
<body>
    ...
    <img src="./pngs/bottles.png" alt="Glass Bottles" class="circle-img bottle-img"> 
    <img src="./pngs/junks.jpg" alt="Junk Items" class="circle-img junk-img">
    <img src="./pngs/workingtv.png" alt="Working TV" class="circle-img tv-img">
    ...
    <div class="description-container"> 
        <div class="text-description">JunkHub is an e-commerce marketplace for 
                                      ...
                                      sustainability and turn waste into valuable resources. With secure 
                                      transactions, real-time pricing, and a user-friendly platform, we 
                                      make junk trading more efficient, profitable, and eco-friendly. 
                                      Join us in building a greener future!</div></div>

    <div class="divider"></div>

    <div class="logoo-circle"></div>
